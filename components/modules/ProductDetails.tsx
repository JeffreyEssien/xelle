...
export default function ProductDetails({ product }: ProductDetailsProps) {
    ...
    return (
        ...
        >
            ...
            <h1 className="font-serif text-2xl sm:text-3xl md:text-4xl text-brand-dark mb-2 leading-tight">{product.name}</h1>
            <p className="text-sm text-brand-dark/35 mb-5">by {product.brand}</p>

            {/* Price */}
            <div className="flex items-baseline gap-3 mb-6">
                <p className="font-serif text-3xl font-bold text-brand-dark">{formatCurrency(currentPrice)}</p>
            </div>
